...
'fixOnTarget': true if one of the fixation lands on the bounding box of the target; flase otherwise. Note that in the paper, only scanpaths with fixOnTarget=true are used for evaluation.
